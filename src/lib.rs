...
pub use crate::swagger::{build_open_api, types::{ApiEndpoint, ApiEndpointMethod, ApiProject}};
...
mod tests {
    ...
    impl ApiEndpointTest {
        pub fn new(method: ApiEndpointMethod, url_path: String, api_declaration: Option<String>) -> Self {
            Self {
